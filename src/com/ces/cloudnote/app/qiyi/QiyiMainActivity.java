package com.ces.cloudnote.app.qiyi;
...
import com.ces.cloudnote.app.qiyi.account.AccountActivity;
import com.ces.cloudnote.app.qiyi.channel.ChannelActivity;
import com.ces.cloudnote.app.qiyi.home.HomeActivity;
import com.ces.cloudnote.app.qiyi.more.MoreActivity;
...
public class QiyiMainActivity extends TabActivity implements OnClickListener {
	...
	public static String TAB_TAG_ACCOUNT = "account"; //我的帐号
	public static String TAB_TAG_SEARCH = "search";	//搜索
	public static String TAB_TAB_MORE = "more";  // 更多
