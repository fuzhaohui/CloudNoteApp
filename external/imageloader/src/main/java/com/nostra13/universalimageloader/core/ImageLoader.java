...
public class ImageLoader {
	 ...
	 * {@link com.nostra13.universalimageloader.core.assist.ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri      Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param listener {@linkplain com.nostra13.universalimageloader.core.assist.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 ...
	 *                     {@linkplain com.nostra13.universalimageloader.core.assist.ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}. Downloaded image will be decoded
	 ...
	 *                 {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from
	 *                 configuration} will be used.<br />
	 *                 Incoming options should contain {@link com.nostra13.universalimageloader.core.display.FakeBitmapDisplayer} as displayer.
	 * @param listener {@linkplain com.nostra13.universalimageloader.core.assist.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 *                 thread.
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
