 ...
 * with one of a number of {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper.RendererBuilder} classes to suit different use cases (e.g. DASH,
...
public class ExoplayerWrapper implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  /**
   * A callback invoked by a {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper.RendererBuilder}.
   */
  public interface RendererBuilderCallback {
    /**
     * Invoked with the results from a {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper.RendererBuilder}.
     *
     * @param trackNames The names of the available tracks, indexed by {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper}
     ...
     *                          indexed by {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper} TYPE_* constants. May be null
     *                          if there are no types with multiple tracks. An individual element
     *                          may be null if it does not have multiple tracks.
     * @param renderers Renderers indexed by {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper} TYPE_* constants. An
    ...
    /**
     * Invoked if a {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper.RendererBuilder} encounters an error.
     *
   ...
   * {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper.PlaybackListener#onError(Exception)} will be invoked.
   *
   * <p>
   * Implementing an {@link com.google.android.libraries.mediaframework.exoplayerextensions.ExoplayerWrapper.InternalErrorListener} is a good way to identify why ExoPlayer may be
