 ...
 *
 * <p>The UI appears when the container containing the {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer} is tapped. It
...
public class PlaybackControlLayer implements Layer, PlayerControlCallback {
  ...
  /**
   * Message handler which allows us to send delayed messages to the {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer}
  ...
  /**
   * Used by the {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer.MessageHandler} to indicate that media controls should fade out.
   */
  private static final int FADE_OUT = 1;

  /**
   * Used by the {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer.MessageHandler} to indicate that media controls should update progress bar.
   */
   ...
   * {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer.FullscreenCallback} associated with this object.
   */
  ...
  /**
   * The drawable that will be displayed in the {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer#logoImageView}.
   */
  ...
  /**
   * The title displayed in the {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer#videoTitleView}.
   */
  ...
  /**
   * The view created by this {@link com.google.android.libraries.mediaframework.layeredvideo.PlaybackControlLayer}
   */
