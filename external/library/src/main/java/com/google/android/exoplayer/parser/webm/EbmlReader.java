...
/* package */ interface EbmlReader {
  ...
  /**
   * Reads a fixed number of bytes from the contents of a binary element into a {@link java.nio.ByteBuffer}.
   *
   * @param inputStream The input stream from which data should be read
   * @param byteBuffer The {@link java.nio.ByteBuffer} to which data should be written
