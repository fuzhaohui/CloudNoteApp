...
package com.ces.cloudnote.app.photo;
...
import com.ces.cloudnote.app.photo.utils.BitmapUtils;
import com.ces.cloudnote.app.photo.utils.FileUtils;
import com.ces.cloudnote.app.photo.utils.MediaUtils;
...
public class PhotoProcessingActivity extends Activity implements OnLongClickListener {
	...
	private static class FilterListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (view == null) {
				view = mInflator.inflate(R.layout.photo_filter_list_item, null);
			}
	...
	private static class EditListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View view = convertView;
			if (view == null) {
				view = mInflator.inflate(R.layout.photo_edit_list_item, null);
			}
