...
import com.ces.cloudnote.app.location.LocationActivity;
import com.ces.cloudnote.app.location.GeoFenceActivity;
import com.ces.cloudnote.app.location.NotifyActivity;
import com.ces.cloudnote.app.location.QuestActivity;
    ...
    protected void onStart() {
        ...
        FunctionList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                if (TargetClass != null) {
                    Intent intent = new Intent(BaiduMapActivity.this, TargetClass);
