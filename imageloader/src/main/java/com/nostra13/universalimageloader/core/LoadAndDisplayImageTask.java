...
final class LoadAndDisplayImageTask implements Runnable {
	 ...
	 * for current ImageView at this moment and fire {@link com.nostra13.universalimageloader.core.assist.ImageLoadingListener#onLoadingCancelled(String, android.view.View)}}
	 * event if it doesn't.
	 */
